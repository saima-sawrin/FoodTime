    ...
    <div className=" ">
      <div className=" lg:relative px-4 pt-10 mx-auto lg:py-32 md:px-8 xl:px-20 sm:max-w-xl md:max-w-full   lg:max-w-screen-xl">
        <div className=" max-w-xl mx-auto lg:max-w-screen-xl  ">
          <div className="mb-16 lg:max-w-lg lg:mb-0 ">
            ...
            <div>
              ...
              <div className="relative flex rounded-3xl border-2 border-gray-300 ">
                <input
                  type="text"
                ...
                <button
                  type="button"
                  className="btn py-3 px-4 inline-flex flex-shrink-0 justify-center items-center rounded-3xl border border-transparent font-semibold  focus:z-10 text-white  focus:outline-none focus:ring-2 transition-all text-sm"
                >
                  <FaSearch className="pr-2 w-8"></FaSearch>Search
                </button>
              </div>
            </div>
          </div>
        ...
        <div className=" mt-10 h-full overflow-hidden lg:w-2/3 xl:w-1/2 lg:absolute lg:justify-start lg:bottom-0 lg:right-0 lg:items-end hero ">
          <img
            src={meal}
            className="object-cover object-top h-full w-4/5  max-w-xl -mb-16 rounded lg:ml-64 xl:ml-8 lg:-mb-24 xl:-mb-28 lg:h-auto lg:max-w-screen-md meal"
            alt=""
          />
        </div>
      </div>
